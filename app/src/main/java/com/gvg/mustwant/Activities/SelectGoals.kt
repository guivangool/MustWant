...
class SelectGoals : AppCompatActivity(), OnAcceptCancelButtonClickListener,OnSpinnerButtonCLickListener {
    ...
    override fun onAcceptButtonCLicked() {
        ...
        selectGoalsViewModel.updateGoal(GoalEntity(GoalTypeEnum.ME.number,GoalMeisSelected,0,fragmentSpinnerMe!!.requireView().findViewById<EditText>(R.id.etDays).text.toString().toInt(),0))
        selectGoalsViewModel.updateGoal(GoalEntity(GoalTypeEnum.HOME.number,GoalHomeisSelected,0,fragmentSpinnerHome!!.requireView().findViewById<EditText>(R.id.etDays).text.toString().toInt(),0))
        selectGoalsViewModel.updateGoal(GoalEntity(GoalTypeEnum.RELATIONS.number,GoalRelationisSelected,0,fragmentSpinnerRelations!!.requireView().findViewById<EditText>(R.id.etDays).text.toString().toInt(),0))
        selectGoalsViewModel.updateGoal(GoalEntity(GoalTypeEnum.WORK.number,GoalWorkisSelected,0,fragmentSpinnerWork!!.requireView().findViewById<EditText>(R.id.etDays).text.toString().toInt(),0))
        finish()
    }
